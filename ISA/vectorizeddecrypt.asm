...
subValueAtIndex:
    ...
    addi $t4, $zero, 0x4BC # Loads address of Inv-S-Box
    add $t2, $t2, $t4 # Sums address of Inv-S-Box plus offset
...
mixColumns:
    addi $t1, $zero, 0x120 # Loads address for matrix
...
round_Loop5:
    ...
    addi $t4, $zero, 0x8740 # Loads memory address of state
...
encrypt:
    lw $t0, $zero, 0x8740 # Saves state memory address to t0
